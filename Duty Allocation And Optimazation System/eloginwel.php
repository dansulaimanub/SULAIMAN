<?php 
	...
	$sql1 = "SELECT `pname`, `duedate`, `enddate` FROM `project` WHERE eid = $id and status = 'Due'";
...
<html>
<head>
	<title>Staff Panel | Duty Allocation And Optimization System</title>
...
<body>
	...
	<header>
		<nav>
			<h1>Duty Allocation and optimization System</h1>
			<ul id="navli">
				<li><a class="homered" href="eloginwel.php?id=<?php echo $id?>"">HOME</a></li>
				<li><a class="homeblack" href="myprofile.php?id=<?php echo $id?>"">My Profile</a></li>
				<li><a class="homeblack" href="empproject.php?id=<?php echo $id?>"">My Duty</a></li>
	...
	<div>
		<!-- <h2>Welcome <?php echo "$empName"; ?> </h2> -->
		    	...
		    	<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">Staff Dashboard </h2>
    	<table>
    	...
    	<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">Projects/Duty</h2>
    	...
    	<table>
			...
			<?php
				while ($employee1 = mysqli_fetch_assoc($result1)) {
					...
					echo "<td>".$employee1['duedate']."</td>";  echo "<td>".$employee1['enddate']."</td>";
